...
import { QueuesGateway as QueuesGateway_2 } from './queues';
...
export declare function getGlobalServices({ sharedOptions, allWorkerRoutes, fallbackWorkerName, loopbackPort, log, }: GlobalServicesOptions): Service[];
...
export declare const PLUGIN_ENTRIES: ["core" | "kv" | "cache" | "do" | "d1" | "queues" | "r2", ValueOf<{
    ...
    }>, z.ZodFunction<z.ZodTuple<[z.ZodType<Request_4<RequestInitCfType_3>, z.ZodTypeDef, Request_4<RequestInitCfType_3>>], z.ZodUnknown>, z.ZodUnion<[z.ZodType<Response_4, z.ZodTypeDef, Response_4>, z.ZodPromise<z.ZodType<Response_4, z.ZodTypeDef, Response_4>>]>>]>>>;
    outboundService: z.ZodOptional<z.ZodUnion<[z.ZodString, z.ZodObject<{
    network: z.ZodObject<{
    allow: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
    deny: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
    ...
    } | ((args_0: Request_4<RequestInitCfType_3>, ...args_1: unknown[]) => Response_4 | Promise<Response_4>)> | undefined;
    outboundService?: string | {
    network: {
    allow?: string[] | undefined;
    deny?: string[] | undefined;
    ...
    timers: z.ZodOptional<z.ZodType<Timers_2<unknown>, z.ZodTypeDef, Timers_2<unknown>>>;
    upstream: z.ZodOptional<z.ZodString>;
    cf: z.ZodOptional<z.ZodUnion<[z.ZodBoolean, z.ZodString, z.ZodRecord<z.ZodString, z.ZodAny>]>>;
    liveReload: z.ZodOptional<z.ZodBoolean>;
    }, "strip", z.ZodTypeAny, {
...
export declare type QueueEnqueueOn = (queueName: string, consumer: QueueConsumer, messages: (Message | Buffer)[]) => void;
...
export declare class QueuesGateway {
    ...
    enqueue(enqueueOn: QueueEnqueueOn, consumer: QueueConsumer, messages: (Message | Buffer)[]): void;
}
...
export declare type R2CreateMultipartUploadOptions = OmitRequest<z.infer<typeof R2CreateMultipartUploadRequestSchema>>;
...
export declare class R2Gateway {
    ...
    get(key: string, options?: R2GetOptions): Promise<R2ObjectBody | R2Object>;
    put(key: string, value: ReadableStream<Uint8Array>, valueSize: number, options: R2PutOptions): Promise<R2Object>;
    delete(keys: string | string[]): Promise<void>;
    list(opts?: R2ListOptions): Promise<R2Objects>;
    createMultipartUpload(key: string, opts: R2CreateMultipartUploadOptions): Promise<R2CreateMultipartUploadResponse>;
    ...
    completeMultipartUpload(key: string, uploadId: string, parts: R2PublishedPart[]): Promise<R2Object>;
    abortMultipartUpload(key: string, uploadId: string): Promise<void>;
}

export declare type R2GetOptions = OmitRequest<z.infer<typeof R2GetRequestSchema>>;
...
export declare type R2ListOptions = OmitRequest<z.infer<typeof R2ListRequestSchema>>;
...
export declare type R2PutOptions = OmitRequest<z.infer<typeof R2PutRequestSchema>>;
...
export declare type ReducersRevivers = Record<string, (value: unknown) => unknown>;
